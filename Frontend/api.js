...
// const API_BASE = "https://artcraft-web-app-project.onrender.com";   // Change to your server URL
// const BASE_URL = "https://artcraft-web-app-project.onrender.com";
...
//   }
// })();
const API_BASE = "https://artcraft-web-app-project.onrender.com";
...
async login(email, password, role) {
const data = await this._fetch("POST", "/auth/login", {
email: email,
password: password,
role: role
}, true);
...
async logout() {
try {
await this._fetch("POST", "/auth/logout");
} catch (e) {}
